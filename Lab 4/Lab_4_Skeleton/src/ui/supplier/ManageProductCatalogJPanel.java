...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        Product selecterProduct =(Product) tblProducts.getValueAt(row, 0);
        ViewProductDetailJPanel vdpj=new ViewProductDetailJPanel((workArea), selecterProduct);
        workArea.add("ViewProductDetailJPanel",vdpj);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
          SearchForProductJPanel cnpjp = new SearchForProductJPanel(workArea, supplier);
        workArea.add("SearchForProductJPanel", cnpjp);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(row<0) {
            ...
            return;
                ...
                Product selecterProduct =(Product) tblProducts.getValueAt(row, 0);
                supplier.getProductCatalog().removeProduct(selecterProduct);
                refreshTable();
