...
//        supplier.getProductCatalog().getProductCatalog();
int pid= Integer.parseInt(idField.getText());
       for(Product product :supplier.getProductCatalog().getProductCatalog()) {
           if(product.getId()==pid) {
               ViewProductDetailJPanel view=new ViewProductDetailJPanel( workArea, product) ;
                 workArea.add("SearchForProductJPanelResult",view);
