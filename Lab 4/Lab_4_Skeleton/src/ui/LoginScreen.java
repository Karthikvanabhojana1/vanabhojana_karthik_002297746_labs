...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        JPanel selecterPanel=(JPanel) cmbRoles.getSelectedItem();
        if(selecterPanel.getClass()==SupplierWorkAreaJPanel.class) {
if(selectedSupplier==null){
    JOptionPane.showMessageDialog(this, "Please Select Supplier to login under supplier role");
    return;
}
else{
    selecterPanel=new SupplierWorkAreaJPanel(mainWorkArea, selectedSupplier);
}
        }
        mainWorkArea.add("WordAreaPanel", selecterPanel);
    ...
    private void populateRoleCombo() {
        ...
        AdminWorkAreaJPanel adminPanel1=new AdminWorkAreaJPanel(mainWorkArea, supplierDirectory);
        
        SupplierWorkAreaJPanel supplierPanel1=new SupplierWorkAreaJPanel(mainWorkArea, selectedSupplier);
      
        cmbRoles.addItem(adminPanel1);
        cmbRoles.addItem(supplierPanel1);
