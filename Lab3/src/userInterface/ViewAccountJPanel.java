...
ViewAccountJPanel(JPanel userProcessContainer, Account account) {
    ...
    private void initComponents() {
        ...
        lblCreateAcoount.setText("View Details");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtAccountNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblAccountNumber))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(accountNumber.isEmpty() || routingNumber.isEmpty()|| bankName.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please Enter the Details for Updating");
        }
        else{
