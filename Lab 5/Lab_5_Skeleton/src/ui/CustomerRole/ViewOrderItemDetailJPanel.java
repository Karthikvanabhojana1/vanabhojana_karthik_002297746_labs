...
public class ViewOrderItemDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewOrderItemDetailJPanel(OrderItems items, JPanel userProcessContainer) {

        initComponents();
        this.items = items;
        this.userProcessContainer = userProcessContainer;

        txtProductId.setText(String.valueOf(items.getProduct().getModelNumber()));
        txtProductName.setText(items.getProduct().getProdName());
        txtSalesPrice.setText(String.valueOf(items.getProduct().getPrice()));
        txtQuantity.setText(String.valueOf(items.getProduct().getAvail()));
txtTotal.setText(String.valueOf(items.getQuantity()*items.getSalePrice()));
    }
