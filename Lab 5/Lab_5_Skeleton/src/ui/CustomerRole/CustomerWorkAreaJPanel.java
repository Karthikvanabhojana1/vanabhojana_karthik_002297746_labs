...
public class CustomerWorkAreaJPanel extends javax.swing.JPanel {
   ...
   JPanel userProcessContainer;
    ...
    public CustomerWorkAreaJPanel(JPanel upc, SupplierDirectory sd, MasterOrderList masterOrderList) {
        initComponents();
...
//        Supplier supplier = (Supplier) cmbSupplier.getSelectedItem();
        BrowseProductsJPanel browse = new BrowseProductsJPanel(userProcessContainer, supplierDirectory,masterOrderList);
        userProcessContainer.add("BrowseProductsJPanel", browse);
