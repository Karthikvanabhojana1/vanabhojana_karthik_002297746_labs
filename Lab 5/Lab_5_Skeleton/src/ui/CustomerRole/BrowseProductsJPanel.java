...
public class BrowseProductsJPanel extends javax.swing.JPanel {
     ...
     */
    public BrowseProductsJPanel(JPanel upc, SupplierDirectory sd, MasterOrderList masterOrderList) {
        initComponents();
    ...
    private void btnProductDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductDetailsActionPerformed
        ...
        Product productselected = (Product) tblProductCatalog.getValueAt(selectedrow, 0);
        ViewProductDetailJPanel viewProduct = new ViewProductDetailJPanel(userProcessContainer, productselected);
        userProcessContainer.add("ViewProductDetailJPanel", viewProduct);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        OrderItems item = (OrderItems) tblCart.getValueAt(selectedrow, 0);
        int quantity = 0;
        try {
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        OrderItems item = (OrderItems) tblCart.getValueAt(selectedrow, 0);
        ViewOrderItemDetailJPanel vieworder = new ViewOrderItemDetailJPanel(item, userProcessContainer);
        userProcessContainer.add("ViewOrderItemDetailJPanel", vieworder);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if (salesPrice >= productselected.getPrice()) {
            
        } else {
            JOptionPane.showMessageDialog(this, "Price should be more than that is in the set price.");
            return;
        }
        OrderItems item = currentOrder.findProduct(productselected);
        
        if (item == null) {
            if (productselected.getAvail() >= quantity) {
                
                currentOrder.addNewOderItem(productselected, salesPrice, quantity);
                productselected.setAvail(productselected.getAvail() - quantity);
    ...
    private void populateCartTable() {
        ...
        model.setRowCount(0);
        for (OrderItems oi : currentOrder.getOrderItemList()) {
